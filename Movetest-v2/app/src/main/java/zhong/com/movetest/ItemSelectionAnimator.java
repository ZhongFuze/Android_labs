...
class ItemSelectionAnimator {
    ...
    private com.imangazaliev.circlemenu.CircleMenuButton currentMenuButton;
    ...
    void startSelectAnimation(com.imangazaliev.circlemenu.CircleMenuButton menuButton, float buttonAngle) {
        if (isAnimating) {
            return;
        }
