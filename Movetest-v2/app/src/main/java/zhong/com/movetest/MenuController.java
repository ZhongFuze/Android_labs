...
class MenuController {
    ...
    private List<com.imangazaliev.circlemenu.CircleMenuButton> buttons;
    private float menuCenterX, menuCenterY;
    private float startAngle;
    private int distance;
    private boolean isOpened;

    private final com.imangazaliev.circlemenu.ItemSelectionAnimator itemSelectionAnimator;
    private final MenuControllerListener listener;


    MenuController(Context context,
                   List<com.imangazaliev.circlemenu.CircleMenuButton> menuButtons,
        ...
        this.itemSelectionAnimator = new com.imangazaliev.circlemenu.ItemSelectionAnimator(context, this, listener, menuCenterX, menuCenterY, distance);

        View.OnClickListener onButtonItemClickListener = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                com.imangazaliev.circlemenu.CircleMenuButton menuButton = (com.imangazaliev.circlemenu.CircleMenuButton) v;
        ...
        for (com.imangazaliev.circlemenu.CircleMenuButton menuButton : buttons) {
    ...
    private void layoutButtons(float distance) {
        ...
        for (int i = 0; i < buttonsCount; i++) {
            com.imangazaliev.circlemenu.CircleMenuButton button = buttons.get(i);
    ...
    void enableButtons(boolean enabled) {
        for (com.imangazaliev.circlemenu.CircleMenuButton button : buttons) {
