...
public class FancyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Debug","fancy_user_id: "+Data.getUser_id());
//        final int youruser_id3 = (int) getIntent().getSerializableExtra("youruser_id2");
        ...
        listView_content.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(FancyActivity.this, HeroDetailActivity.class);
                Bundle mBundle = new Bundle();
                mBundle.putSerializable("myhero",people);
//                int youruser_id4 = youruser_id3;
//                mBundle.putSerializable("youruser_id3",youruser_id4);
